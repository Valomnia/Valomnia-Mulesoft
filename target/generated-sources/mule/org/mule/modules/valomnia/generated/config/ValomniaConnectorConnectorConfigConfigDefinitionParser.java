...
import org.mule.modules.valomnia.generated.connectivity.ValomniaConnectorConfigConnectionManagementConnectionManager;
...
public class ValomniaConnectorConnectorConfigConfigDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(ValomniaConnectorConnectorConfigConfigDefinitionParser.class);
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        setInitMethodIfNeeded(builder, ValomniaConnectorConfigConnectionManagementConnectionManager.class);
        setDestroyMethodIfNeeded(builder, ValomniaConnectorConfigConnectionManagementConnectionManager.class);
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition(ValomniaConnectorConfigConnectionManagementConnectionManager.class.getName());
            ...
            logger.error(("Cannot launch the mule app, the configuration [config] within the connector [valomnia] is not supported in mule "+ muleVersion));
            throw new BeanDefinitionParsingException(new Problem(("Cannot launch the mule app, the configuration [config] within the connector [valomnia] is not supported in mule "+ muleVersion), new Location(parserContext.getReaderContext().getResource()), null, noClassDefFoundError));
        }
    }
