...
public class SaveCustomerGroupAssignTestCases extends AbstractTestCase<ValomniaConnector> {

    public SaveCustomerGroupAssignTestCases() {
    ...
    public void verify() {
      ...
      CustomerGroupAssign obj = new CustomerGroupAssign();
        ...
        ArrayList<CustomerGroupAssign> list = null;
        ...
        if (!exist)
            assertEquals(getConnector().saveCustomerGroupAssign(obj), expected2);
        else
            assertEquals(getConnector().saveCustomerGroupAssign(obj), expected1);
    }
