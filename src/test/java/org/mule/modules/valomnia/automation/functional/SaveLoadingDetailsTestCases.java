...
public class SaveLoadingDetailsTestCases extends AbstractTestCase<ValomniaConnector> {

    public SaveLoadingDetailsTestCases() {
    ...
    public void verify() {
       ...
       LoadingDetails obj = new LoadingDetails();
        ...
        ArrayList<LoadingDetails> list = null;
        ...
        if (exist)
            assertEquals(getConnector().saveLoadingDetails(obj), expected1);
        else
            assertEquals(getConnector().saveLoadingDetails(obj), expected2);
    }
