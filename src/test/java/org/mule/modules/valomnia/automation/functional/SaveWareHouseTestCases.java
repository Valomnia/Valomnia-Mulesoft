...
public class SaveWareHouseTestCases extends AbstractTestCase<ValomniaConnector> {

    public SaveWareHouseTestCases() {
    ...
    public void verify() {
       ...
       WareHouse obj = new WareHouse();
        ...
        if (exist)
            assertEquals(getConnector().saveWareHouse(obj), expected1);
        else
            assertEquals(getConnector().saveWareHouse(obj), expected2);
    }
