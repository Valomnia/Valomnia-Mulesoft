...
public class SaveCustomerPriceListTestCases extends AbstractTestCase<ValomniaConnector> {

    public SaveCustomerPriceListTestCases() {
    ...
    public void verify() {
       ...
       CustomerPriceList obj = new  CustomerPriceList();
        ...
        ArrayList<CustomerPriceList> list = null;
        ...
        if (exist)
            assertEquals(getConnector().saveCustomerPriceList(obj), expected1);
        else
            assertEquals(getConnector().saveCustomerPriceList(obj), expected2);
    }
