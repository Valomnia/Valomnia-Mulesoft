...
public class SaveLoadingTestCases extends AbstractTestCase<ValomniaConnector> {

    public SaveLoadingTestCases() {
    ...
    public void verify() {
       ...
       Loading obj = new Loading();
        ...
        if (exist)
            assertEquals(getConnector().saveLoading(obj), expected1);
        else
            assertEquals(getConnector().saveLoading(obj), expected2);
    }
