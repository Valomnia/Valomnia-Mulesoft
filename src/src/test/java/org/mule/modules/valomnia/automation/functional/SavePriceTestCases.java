...
public class SavePriceTestCases extends AbstractTestCase<ValomniaConnector> {

    public SavePriceTestCases() {
...
@Test
    public void verify() {
        ...
        if (exist)
            assertEquals(getConnector().savePrice(obj), expected1);
        else
            assertEquals(getConnector().savePrice(obj), expected2);
    }
