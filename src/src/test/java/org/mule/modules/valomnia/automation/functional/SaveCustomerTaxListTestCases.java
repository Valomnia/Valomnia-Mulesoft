...
public class SaveCustomerTaxListTestCases extends AbstractTestCase<ValomniaConnector> {

    public SaveCustomerTaxListTestCases() {
    ...
    public void verify() {
        ...
        if (!exist)
            assertEquals(getConnector().saveCustomerTaxList(obj), expected2);
        else
            assertEquals(getConnector().saveCustomerTaxList(obj), expected1);
    }
