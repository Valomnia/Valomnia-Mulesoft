 ...
 * 
 * base URL creation creation of the Http(Post/Get) read response from input HttpResponse string Json-formated parsing to object Java Map parsing to String Json-formated
 * 
 */
...
public abstract class AbstractValomniaClient {
    ...
    /**
     * @return the base URL for the service, inclduing what is added by { AbstractValomniaClient#extendGetBaseUrl(StringBuilder)}
     */
