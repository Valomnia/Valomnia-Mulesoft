        ...
        try {
            ...
            if (line != null) {
                Map<String, Object> rootMapObject1 = parseFromJson(line,
                        Map.class);
                Type mapType = new TypeToken<List<T>>() {
                }.getType();
        ...
        try {
            ...
            if (response.getStatusLine()
                ...
                if ((line = rd.readLine()) != null) {
                    if (saved != saved1)
                        result = new Message("Success", "created " + resourcePath.substring(0, resourcePath.indexOf("Connector"))).toString();
                    else
                        result = new Message("Succes", "Updated" + resourcePath.substring(0, resourcePath.indexOf("Connector"))).toString();
                }
                ...
                if ((line = rd.readLine()) != null) {
                    ...
                    result = new Message(errors.get(0), errors.get(1)).toString();
                }
