...
/**
 * A <code>ValomniaConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link ValomniaConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-05-10T10:20:43+01:00", comments = "Build UNNAMED.2762.e3b1307")
public class ValomniaConnectorLifecycleInjectionAdapter
    extends ValomniaConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(ValomniaConnectorLifecycleInjectionAdapter.class);
