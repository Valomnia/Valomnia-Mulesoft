...
=== Use Cases
Below are a few common use case for the Valomnia Connector v1.0:
...
|Connector Configuration |Select a global cValomnia connector element from the drop-drown.
|Operation |findItems.
...
. Back in the properties editor of the Valomnia Connector v3.0, configure the remaining parameters:
