...
. Drag a Object To Json Transform Message component after the Valomnia connector  v1.0Connector
.

. Add a Logger component after the Valomnia Connector..Add a XML to JSON transformer.
